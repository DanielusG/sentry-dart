...
- Bump Android SDK from v7.9.0 to v8.21.1 ([#99](https://github.com/DanielusG/sentry-dart/pull/99))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8211)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.21.1)
