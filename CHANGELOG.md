...
- Bump Android SDK from v7.9.0 to v8.37.0 ([#139](https://github.com/DanielusG/sentry-dart/pull/139))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.37.0)
