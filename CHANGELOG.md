...
- Bump Android SDK from v7.9.0 to v8.2.0 ([#55](https://github.com/DanielusG/sentry-dart/pull/55))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#820)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.2.0)
