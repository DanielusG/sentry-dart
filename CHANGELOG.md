...
- Bump Android SDK from v7.9.0 to v8.19.1 ([#93](https://github.com/DanielusG/sentry-dart/pull/93))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8191)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.19.1)
