...
- Bump Android SDK from v7.9.0 to v8.28.0 ([#117](https://github.com/DanielusG/sentry-dart/pull/117))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.28.0)
