...
- Bump Android SDK from v7.9.0 to v8.37.1 ([#140](https://github.com/DanielusG/sentry-dart/pull/140))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8371)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.37.1)
