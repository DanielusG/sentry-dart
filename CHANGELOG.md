...
- Bump Android SDK from v7.9.0 to v8.17.0 ([#85](https://github.com/DanielusG/sentry-dart/pull/85))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.17.0)
