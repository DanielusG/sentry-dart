...
- Bump Android SDK from v7.9.0 to v8.35.0 ([#136](https://github.com/DanielusG/sentry-dart/pull/136))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.35.0)
