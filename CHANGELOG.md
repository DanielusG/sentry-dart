...
- Bump Android SDK from v7.9.0 to v8.1.0 ([#51](https://github.com/DanielusG/sentry-dart/pull/51))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#810)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.1.0)
