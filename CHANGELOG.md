...
- Bump Android SDK from v7.9.0 to v8.7.0 ([#62](https://github.com/DanielusG/sentry-dart/pull/62))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.7.0)
