...
- Bump Android SDK from v7.9.0 to v8.18.0 ([#90](https://github.com/DanielusG/sentry-dart/pull/90))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.18.0)
