...
- Bump Android SDK from v7.9.0 to v8.13.1 ([#71](https://github.com/DanielusG/sentry-dart/pull/71))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8131)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.13.1)
