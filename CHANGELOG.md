...
- Bump Android SDK from v7.9.0 to v8.23.0 ([#103](https://github.com/DanielusG/sentry-dart/pull/103))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.23.0)
