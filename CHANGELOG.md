...
- Bump Android SDK from v7.9.0 to v8.26.0 ([#109](https://github.com/DanielusG/sentry-dart/pull/109))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.26.0)
