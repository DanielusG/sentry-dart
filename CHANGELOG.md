...
- Bump Android SDK from v7.9.0 to v8.4.0 ([#59](https://github.com/DanielusG/sentry-dart/pull/59))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#840)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.4.0)
