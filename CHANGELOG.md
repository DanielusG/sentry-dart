...
- Bump Android SDK from v7.9.0 to v8.6.0 ([#61](https://github.com/DanielusG/sentry-dart/pull/61))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#860)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.6.0)
