...
- Bump Android SDK from v7.9.0 to v8.0.0 ([#49](https://github.com/DanielusG/sentry-dart/pull/49))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#800)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.0.0)
