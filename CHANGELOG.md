...
- Bump Android SDK from v7.9.0 to v8.16.0 ([#84](https://github.com/DanielusG/sentry-dart/pull/84))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8160)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.16.0)
