...
- Bump Android SDK from v7.9.0 to v8.12.0 ([#69](https://github.com/DanielusG/sentry-dart/pull/69))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.12.0)
