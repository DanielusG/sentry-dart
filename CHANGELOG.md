...
- Bump Android SDK from v7.9.0 to v8.3.0 ([#56](https://github.com/DanielusG/sentry-dart/pull/56))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#830)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.3.0)
