...
- Bump Android SDK from v7.9.0 to v8.14.0 ([#80](https://github.com/DanielusG/sentry-dart/pull/80))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8140)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.14.0)
