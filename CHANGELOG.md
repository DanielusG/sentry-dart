...
- Bump Android SDK from v7.9.0 to v8.19.0 ([#92](https://github.com/DanielusG/sentry-dart/pull/92))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.19.0)
