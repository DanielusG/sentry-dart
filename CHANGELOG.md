...
- Bump Android SDK from v7.9.0 to v8.30.0 ([#123](https://github.com/DanielusG/sentry-dart/pull/123))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.30.0)
