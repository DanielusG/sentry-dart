...
- Bump Android SDK from v7.9.0 to v8.11.0 ([#67](https://github.com/DanielusG/sentry-dart/pull/67))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8110)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.9.0...8.11.0)
